    ...
    public class PoseEditorManager : MonoBehaviour
    {
        ...
        public void DrawHandle(bool colorize = true)
        {
            ...
            for (var i = 0; i < bones.Length; i++)
            {
                ...
                var fmh_432_59_638720351490379639 = bones[i].rotation; Handles.FreeMoveHandle(bones[i].position, handleSize * worldSize * handle.handleScale, Vector3.zero, Handles.SphereHandleCap);
